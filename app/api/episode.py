...
async def get_episodes(session: Annotated[AsyncSession, Depends(db_helper.session_getter)],):
...
async def create_episode(session: Annotated[AsyncSession, Depends(db_helper.session_getter)],):
    pass
